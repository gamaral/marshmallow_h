...
typedef _PNG_CALLBACK_(void, *png_error_ptr, (png_structp, png_const_charp));
typedef _PNG_CALLBACK_(void, *png_rw_ptr, (png_structp, png_bytep, png_size_t));
typedef _PNG_CALLBACK_(void, *png_flush_ptr, (png_structp));
typedef _PNG_CALLBACK_(void, *png_read_status_ptr, (png_structp, png_uint_32,
    int));
typedef _PNG_CALLBACK_(void, *png_write_status_ptr, (png_structp, png_uint_32,
    int));

#ifdef PNG_PROGRESSIVE_READ_SUPPORTED
typedef _PNG_CALLBACK_(void, *png_progressive_info_ptr, (png_structp, png_infop));
typedef _PNG_CALLBACK_(void, *png_progressive_end_ptr, (png_structp, png_infop));
 ...
 */
typedef _PNG_CALLBACK_(void, *png_progressive_row_ptr, (png_structp, png_bytep,
    png_uint_32, int));
#endif

#if defined(PNG_READ_USER_TRANSFORM_SUPPORTED) || \
    defined(PNG_WRITE_USER_TRANSFORM_SUPPORTED)
typedef _PNG_CALLBACK_(void, *png_user_transform_ptr, (png_structp, png_row_infop,
    png_bytep));
#endif

#ifdef PNG_USER_CHUNKS_SUPPORTED
typedef _PNG_CALLBACK_(int, *png_user_chunk_ptr, (png_structp,
    png_unknown_chunkp));
#endif
#ifdef PNG_UNKNOWN_CHUNKS_SUPPORTED
typedef _PNG_CALLBACK_(void, *png_unknown_chunk_ptr, (png_structp));
#endif
 ...
 * following.
 */
typedef _PNG_CALLBACK_(png_voidp, *png_malloc_ptr, (png_structp,
    png_alloc_size_t));
typedef _PNG_CALLBACK_(void, *png_free_ptr, (png_structp, png_voidp));
